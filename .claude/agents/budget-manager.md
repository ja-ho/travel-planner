...
- 일정설계자의 일정표(`trips/<trip-name>/02_itinerary.md`)를 기반으로 비용을 산출한다
- 목적지분석가의 물가 정보(`trips/<trip-name>/01_destination_analysis.md`)를 반영한다
...
`trips/<trip-name>/04_budget.md` 파일로 저장한다:
